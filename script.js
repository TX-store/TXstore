...
const products = [
    ...
    },
    {
        ...
        category: 'servers',
        image: 'https://cdn.discordapp.com/attachments/1459228068043428037/1460342543228207380/5_4_10001250_1.jpg?ex=6966917a&is=69653ffa&hm=a296e795970c7a4bca6c3f1476f14cead8e18eb6c4a5c6468527c3168874bfee&',
        reviews: 280,
    ...
    },
    {
        ...
        category: 'servers',
        image: 'https://cdn.discordapp.com/attachments/1396377051052769313/1459512802241810554/5447b18f3ff226459b66481a3a684808.jpg?ex=69662fb8&is=6964de38&hm=d0ddbf2f40aea525010b209dfa68c1dc50d0eca5dab496cc2a2c4ca3a35cd833&',
        rating: 4.6,
        reviews: 390,
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const winnersLogin = document.getElementById('winnersLogin');
    const winnersSubmit = document.getElementById('winnersSubmit');
    const winnersPassInput = document.getElementById('winnersPassInput');

    if (adminBtn) {
        adminBtn.addEventListener('click', () => {
            winnersLogin.style.display = 'none';
    ...
    if (winnersBtn) {
        winnersBtn.addEventListener('click', () => {
            adminLogin.style.display = 'none';
            if (winnersLogin.style.display === 'none' || winnersLogin.style.display === '') {
                winnersLogin.style.display = 'inline-flex';
                winnersPassInput.focus();
            } else {
                winnersLogin.style.display = 'none';
            }
        });
    ...
    if (winnersSubmit) {
        winnersSubmit.addEventListener('click', () => {
            const pwd = winnersPassInput.value || '';
            const winnersPassword = 'winners123';
            if (pwd === winnersPassword) {
                sessionStorage.setItem('winnersAccess', 'granted');
